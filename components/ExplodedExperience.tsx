...
export default function ExplodedExperience() {
    ...
    return (
        <section className="relative bg-[#0B0B0E] text-white border-t border-white/5">
            ...
            {/* Film Grain overlay matched from hero */}
            <div className="pointer-events-none fixed inset-0 z-[100] h-full w-full opacity-[0.02]" style={{ backgroundImage: 'url("https://upload.wikimedia.org/wikipedia/commons/7/76/1k_Dissolve_Noise_Texture.png")' }}></div>
        </section>
    );
}
